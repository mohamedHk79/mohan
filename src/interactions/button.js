    ...
    async execute(client, config, interaction) {
        ...
        if (type === 'accept') {
            try {
                ...
                await user.send(`تم قبولك في التقديم علي العائله يرجي ارسال الاي دي الخاص بك هنا https://discord.com/channels/1178680966600998952/1249161400320917507`);
            } catch (error) {
            ...
            try {
                ...
                await user.send(`تم رفضك في التقديم علي العائله حظ اوفر المره القادمه`);
            } catch (error) {
